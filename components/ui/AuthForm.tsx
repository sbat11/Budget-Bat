        ...
        <header className='flex flex-col gap-5 md:gap-8'>
            <Link href="/" className="cursor-pointer flex items-center gap-1 px-4">
                <Image 
                    ...
                    alt="Horizon logo"
                />
            <h1 className="text-26 font-ibm-plex-serif font-bold text-black-1">Budget Bat</h1>
          </Link>
                          ...
                          {type === 'sign-up' && (
                            ...
                            <div className='flex gap-4'>
                              ...
                              <div className='flex gap-4'>
                                ...
                                <CustomInput control={form.control} name="ssn" label='SSN' placeholder='Example: 111-11-1111' />
                              </div>
